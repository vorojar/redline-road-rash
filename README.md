...
| 操作 | 按键 |
| --- | --- |
| 油门 / 刹车 / 转向 | WASD、方向键或数字小键盘 8 / 2 / 4 / 6 |
| 自动攻击 / 伺机夺械 | 鼠标左键或空格 |
| 拳击 / 踢击 / 持械攻击 | J / K / L |
| 格挡 / 闪避 / 夺械 | U / I / O |
| 蓄力冲刺 | 按住 Shift，蓄满松开 |
...
电脑左键点击游戏画面或按空格：有武器就挥击；空手时，近身对手露出夺械破绽就抢武器，否则交替拳击、踢击。每次点击或按下空格出手一次，受正常冷却限制。
...
人物以 MakeHuman CC0 成熟人体拓扑为基础，适配赛车服、头盔和游戏骨骼，裤子后片独立蒙皮并随骑姿调整骨盆倾角；程序动画为项目实现，仍有写实度和手感上的迭代空间。网页采用单线程 Compatibility/WebGL 2 导出，性能与原生版本有差异。
