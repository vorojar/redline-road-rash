...
- 赛车服胸背使用 EHAFO 主标，搭配用户提供的 MOTUL、SHOEI、NGK、brembo、Red Bull 贴标；袖腿配有小贴标，跟随衣服蒙皮且保留品牌颜色。
- 摩托与汽车、摩托之间具备实体阻挡，免伤不允许穿车；追尾减速并产生前倾回弹，重撞可摔车。交通车按行驶方向贴合坡度，对向车停车时也保留朝向。比赛中的浮动通知、快捷键说明和摔车文字已移除，保留仪表与教学。
- 转向采用柔和的小幅响应、高速抑制和渐进起转；松手快速收回变道角度，减少持续横移。
- 三条赛道路边各设四块约 12×5 米易哈佛医护主题高架广告牌和两块 12×4 米 OpenAI 高架广告牌（粗单柱、背部钢架与检修平台），另各新增三块 12×5 米 LEOSTO 高架广告牌。另有 NVIDIA、Microsoft、Apple、Amazon、Anthropic、Gemini、Tesla 各一块 12×5 米大牌。每赛道共 16 块，左右各八块交错分布，沿赛道间距至少 100 米；朝向来车，避开桥梁、货运区和维修站，两侧均保留无遮挡植被空间。
- 小地图浅黄色小点显示附近 AI 骑手，自己的红点始终置顶；普通车辆不显示。
- AI 起步前 3 秒按车型正常加速、保持起跑车道，随后 3 秒平滑恢复追赶与交战，避免零速互相等待堵车；弯道限速与车流避让始终生效。
...
人物以 MakeHuman CC0 成熟人体拓扑为基础，适配赛车服、头盔和游戏骨骼；皮衣具有独立于裸体轮廓的腰部余量与浅褶皱，前臂分段转腕避免握把动作拧瘪肘部，裤子后片独立蒙皮并随骑姿调整骨盆倾角。程序动画为项目实现，仍有写实度和手感上的迭代空间。网页采用单线程 Compatibility/WebGL 2 导出，性能与原生版本有差异。
