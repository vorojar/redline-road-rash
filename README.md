...
- 松岭公路、海岸断崖两条赛道，包含连续左右弯和起伏；转向输入改变车头方向，松手后保持行驶方向，必须主动沿弯道转向、出弯反向微调回正；高速过弯只减速、不自动扣稳定值。短暂压路肩不直接摔车，碰撞和受击仍会失衡。
- 转向采用柔和的小幅响应、高速抑制和渐进起转；松手快速停止继续打方向，方便微调和反向回正。
- 5 名对手、车流和警方追击；AI 使用各自车型、冲刺和弯道速度规则。自然追近后提供短暂并排交手窗口，冲刺、拉开距离或车流可打断。
