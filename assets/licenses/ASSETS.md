...
- Interface uses system fonts at runtime and does not redistribute font files.
...
REDLINE is a working local project name. No affiliation with Electronic Arts or Road Rash is claimed. Public release, trademark clearance, third-party store listings, code-signing with a distribution identity and notarization have not been performed.
